import helpers
import plotter_heave_gain as plotters
...
timeframes = [
    {'start': '2016-09-21 02:00', 'end': '2016-09-21 15:00', 'simulation': False},
    {'start': '2016-10-23 21:00', 'end': '2016-10-24 18:00', 'simulation': False},
    {'start': '2016-10-25 03:00', 'end': '2016-10-25 14:00', 'simulation': False},
    {'start': '2016-11-23 18:00', 'end': '2016-11-25 12:00', 'simulation': False},
    {'start': '2016-12-03 22:00', 'end': '2016-12-04 09:00', 'simulation': False},
    {'start': '4-9-19 10:00', 'end': '4-10-19 0:00', 'simulation': False},
    {'start': '4-11-19 10:00', 'end': '4-11-19 20:00', 'simulation': False},
    {'start': '4-12-19 21:00', 'end': '4-13-19 1:26', 'simulation': False},
    {'start': '4-13-19 1:50', 'end': '4-13-19 5:10', 'simulation': False},
    {'start': '4-16-19 2:45', 'end': '4-20-19 11:00', 'simulation': False},
    {'start': '4-20-19 20:50', 'end': '4-23-19 0:24', 'simulation': False},
    {'start': '5-2-19 18:40', 'end': '5-2-19 23:00', 'simulation': False},
    {'start': '5-3-19 3:00', 'end': '5-4-19 1:00', 'simulation': False},
    {'start': '5-4-19 23:53', 'end': '5-6-19 5:35', 'simulation': False},
    {'start': '5-6-19 14:30', 'end': '5-8-19 12:45', 'simulation': False},
    {'start': '5-11-19 0:00', 'end': '5-12-19 5:18', 'simulation': False},
    {'start': '5-13-19 1:22', 'end': '5-14-19 1:22', 'simulation': False},
    {'start': '5-14-19 6:20', 'end': '5-15-19 4:15', 'simulation': False},
    {'start': '5-15-19 20:30', 'end': '5-17-19 20:30', 'simulation': False},
    {'start': '2019-05-18 04:30', 'end': '2019-05-18 08:30', 'simulation': False},
    {'start': '2019-05-19 04:00', 'end': '2019-05-19 14:00', 'simulation': False},
    {'start': '2019-05-19 16:00', 'end': '2019-05-21 08:00', 'simulation': False},
    {'start': '2019-05-25 00:00', 'end': '2019-05-27 06:00', 'simulation': False},
    {'start': '2019-05-28 00:00', 'end': '2019-05-31 12:00', 'simulation': False},
    {'start': '2019-06-01 10:00', 'end': '2019-06-01 18:00', 'simulation': False},
    {'start': '2019-06-01 22:00', 'end': '2019-06-02 04:00', 'simulation': False},
    {'start': '2019-06-02 05:00', 'end': '2019-06-03 03:00', 'simulation': False},
    {'start': '2019-06-03 06:00', 'end': '2019-06-03 13:00', 'simulation': False},
    {'start': '2019-06-03 14:00', 'end': '2019-06-04 07:00', 'simulation': False},
    {'start': '2019-06-07 00:00', 'end': '2019-06-10 00:00', 'simulation': False},
    {'start': '2019-06-10 08:00', 'end': '2019-06-11 12:00', 'simulation': False},
    {'start': '2019-06-13 12:00', 'end': '2019-06-17 02:00', 'simulation': False},
    {'start': '2020-09-17 10:18', 'end': '2020-09-17 11:20', 'simulation': True},  # Tp070_Hs200_Parallel
    {'start': '2020-09-17 11:20', 'end': '2020-09-17 12:21', 'simulation': True},  # Tp070_Hs200_Perpendic
    {'start': '2020-09-17 12:38', 'end': '2020-09-17 13:40', 'simulation': True},  # Tp110_Hs200_Parallel
    {'start': '2020-09-17 13:40', 'end': '2020-09-17 14:41', 'simulation': True},  # Tp110_Hs200_Perpendic
]

datafolder = '../data/'  # data folder in which the data is searched for. default is '../data/'

max_data_point_to_plot = 100000  # Removes data to for quick plotting at the cost of level of detail at high zoom levels
...
plot_power_consumption = False
plot_heave_gain_motions = True
...
filename_key_values = './Projects/HeaveGain/output/key_values.csv'
...
for timeframe in timeframes:
    ...
    if timeframe['simulation']:
        df['Heave_Gain_DC'] *= 3 / 2
        df.loc[df.Heave_Gain_DC > 1, 'Heave_Gain_DC'] = 1

    # calculate the residual heave

    y = df['MRU1_Heave'].diff() / df['Timestamp'].diff().dt.total_seconds()
    df['MRU1_Heave_Vel'] = savgol_filter(y, 13, 2)

    df['Residual_heave_gain_stroke'] = (1 - df['Heave_Gain_Stroke']) * df['MRU1_Heave']
    df['Residual_heave_gain_speed'] = (1 - df['Heave_Gain_Speed']) * df['MRU1_Heave_Vel']
    df['Residual_heave_gain_DC'] = (1 - df['Heave_Gain_DC']) * df['MRU1_Heave_Vel']

    df['Cyl1_Pos_HG'] = df['Cyl1_Pos_Ideal'] - df['Residual_heave_gain_stroke']
    df['Cyl2_Pos_HG'] = df['Cyl2_Pos_Ideal'] - df['Residual_heave_gain_stroke']
    df['Cyl3_Pos_HG'] = df['Cyl3_Pos_Ideal'] - df['Residual_heave_gain_stroke']

    df['Cyl1_Vel_HG'] = df['Cyl1_Vel_Ideal'] - df['Residual_heave_gain_speed']
    df['Cyl2_Vel_HG'] = df['Cyl2_Vel_Ideal'] - df['Residual_heave_gain_speed']
    df['Cyl3_Vel_HG'] = df['Cyl3_Vel_Ideal'] - df['Residual_heave_gain_speed']

    df['Duty_Cycle_HG'] = df['Duty_Cycle'] - 3 * df['Residual_heave_gain_DC'].abs()
    ...
    savenameHGM = './Projects/HeaveGain/plots/' + savename + 'HGM.png'
    ...
    if plot_heave_gain_motions:
        figHGR, axHGR = plotters.heave_gain_motions(df)
        figHGR.set_size_inches(19, 12.8)
        if save_figures: plt.savefig(savenameHGM, bbox_inches='tight', dpi=100)
